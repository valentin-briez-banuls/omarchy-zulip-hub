...
var strings = {
  fr: {
    ...
    homeHelp: "↑/↓ ou j/k naviguent • Entrée affiche • A répond • O ouvre dans Zulip • X marque comme lu • R actualise • Échap ferme",
    ...
    messageTitle: "MESSAGE", loadingMessage: "Chargement du message…",
    restartNeeded: "Mise à jour installée (%1). Redémarrez Omarchy Shell pour l’appliquer.",
    restartNow: "Redémarrer maintenant", restarting: "Redémarrage…",
    backMessages: "Retour aux messages", openInZulip: "Ouvrir dans Zulip",
  ...
  en: {
    ...
    homeHelp: "↑/↓ or j/k navigate • Enter shows • A replies • O opens in Zulip • X marks read • R refreshes • Esc closes",
    ...
    messageTitle: "MESSAGE", loadingMessage: "Loading message…",
    restartNeeded: "Update installed (%1). Restart Omarchy Shell to apply it.",
    restartNow: "Restart now", restarting: "Restarting…",
    backMessages: "Back to messages", openInZulip: "Open in Zulip",
