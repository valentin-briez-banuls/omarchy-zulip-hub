...
var strings = {
  fr: {
    ...
    homeHelp: "↑/↓ ou j/k naviguent • Entrée ouvre • X marque comme lu • R actualise • Échap ferme",
  ...
  en: {
    ...
    homeHelp: "↑/↓ or j/k navigate • Enter opens • X marks read • R refreshes • Esc closes",
